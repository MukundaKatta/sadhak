# Sadhak — AI Job Search Pipeline

## Origin

Sadhak (Sanskrit: साधक, "The Seeker") is an AI-powered job search command center built on Claude Code. It helps you evaluate offers, generate tailored resumes, write cover letters, scan portals, and track your entire application pipeline.

Inspired by [career-ops](https://github.com/santifer/career-ops) by Santiago Fernández.

**It works out of the box, but it's designed to be made yours.** If the archetypes don't match your career, the scoring doesn't fit your priorities, or the templates need a different design — just ask. You (Claude) can edit any file in this system. The user says "change the archetypes to data engineering roles" and you do it.

## What is Sadhak

AI-powered job search automation built on Claude Code: pipeline tracking, offer evaluation, resume tailoring, cover letter generation, portal scanning, and batch processing.

### Main Files

| File | Function |
|------|----------|
| `cv.md` | Canonical CV / resume (create this) |
...
| `templates/cv-template.html` | HTML template for resume PDFs |
...
>
> The more context you give me, the better I filter and tailor. Think of it as onboarding a recruiter."

Store insights in `config/profile.yml` (under narrative) or in `article-digest.md` if they share proof points. Update `modes/_shared.md` archetypes if needed.

**After every evaluation, learn.** If the user says "this score is too high" or "you missed that I have experience in X", update your understanding. Adjust framing in `_shared.md` or notes in `profile.yml`.

#### Step 6: Ready
Once all files exist, confirm:
> "You're all set! You can now:
> - Paste a job URL to evaluate it
> - Run `/sadhak scan` to search portals
> - Run `/sadhak` to see all commands
>
...
- Node.js (ESM modules), Playwright (PDF + scraping), YAML (config), HTML/CSS (templates), Markdown (data)
